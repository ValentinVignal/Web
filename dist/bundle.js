...
const Reducer_1 = __webpack_require__(49);
const Operations_1 = __webpack_require__(50);
const Resume_1 = __webpack_require__(51);
const Transactions_1 = __webpack_require__(52);
...
const FilterLink = ({ filter, currentFilter, children }) => {
    ...
    return (React.createElement("a", { href: '#', onClick: e => {
            e.preventDefault();
            store.dispatch({
...
const getVisibleTransactions = (banque, filter) => {
    switch (filter) {
        case 'SHOW_RESUME':
            return (React.createElement(Resume_1.Resume, { banque: banque }));
        case 'SHOW_TRANSACTIONS':
            return (React.createElement(Transactions_1.Transactions, { store: store, banque: store.getState().banque }));
        case 'SHOW_OPERATIONS':
            return (React.createElement(Operations_1.Operations, { banque: store.getState().banque, store: store }));
    }
};
class TransactionApp extends React.Component {
    render() {
        const { banque, visibilityFilter } = this.props;
        const visibleTransactions = getVisibleTransactions(banque, visibilityFilter);
        return (React.createElement("div", null,
            React.createElement(FilterLink, { filter: 'SHOW_RESUME', currentFilter: visibilityFilter }, "Resume"),
            React.createElement(FilterLink, { filter: 'SHOW_TRANSACTIONS', currentFilter: visibilityFilter }, "Transactions"),
            React.createElement(FilterLink, { filter: 'SHOW_OPERATIONS', currentFilter: visibilityFilter }, "Operations"),
            visibleTransactions));
    }
}
const render = () => {
    ReactDOM.render(React.createElement(TransactionApp, { banque: store.getState().banque, visibilityFilter: store.getState().visibilityFilter }), document.getElementById('root'));
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11), __webpack_require__(32)(module)))
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(15),B=__webpack_require__(3),C=__webpack_require__(2),ba=__webpack_require__(16),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ia=__webpack_require__(20),D=__webpack_require__(4);
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(7);
const banqueReducer = (state, action) => {
    if (state === null) {
    ...
    switch (action.type) {
        ...
        case 'VALIDATE_TRANSACTION:':
            ...
            function renvoie_montant(liste, action) {
                for (let t of liste) {
                    if (t.id == action.id) {
                        return (t.montant);
                    }
            ...
            return {
                transactions: state.transactions.map(t => (t.id === action.id)
                    ? Object.assign({}, t, { validated: true }) : t),
...
const visibilityFilter = (state = 'SHOW_RESUME', action) => {
    switch (action.type) {
...
const transactionApp = redux_1.combineReducers({
    banque: banqueReducer,
    visibilityFilter
});
exports.default = transactionApp;
...
class Operations extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("form", null,
            React.createElement("input", { type: "date", onChange: this.handleChangeDate }),
            React.createElement("input", { type: 'number', value: this.state.input_montant, onChange: this.handleChangeMontant }),
            ...
            React.createElement("ul", null, this.props.banque.transactions.map(transaction => React.createElement("li", { key: transaction.id, onClick: () => {
                    self.props.store.dispatch({
...
Operations.nextTransactionId = 0;
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const afficheTransactions_Resume = (tableau) => {
    let nb = 0;
    let tab_retour = [];
    for (var k = 0; k < tableau.length && (nb < 10); k++) {
        if (tableau[k].validated) {
            tab_retour.push(React.createElement("tr", null,
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("table", null,
                React.createElement("tbody", null,
                    React.createElement("tr", null, afficheTransactions_Resume(this.props.banque.transactions))))));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const afficheTransactions_Transactions = (tableau) => {
    let nb = 0;
    let tab_retour = [];
    for (let k = 0; k < tableau.length && (nb < 10); k++) {
        if (!tableau[k].validated) {
            tab_retour.push(React.createElement("tr", null,
                React.createElement("td", null,
                    "Transaction n\u00B0",
            ...
            React.createElement("table", null,
                React.createElement("thead", null,
                    React.createElement("tr", null,
                        React.createElement("td", null, " Numero de la transaction "),
                        React.createElement("td", null, " Montant de la transaction "))),
                React.createElement("tbody", null, afficheTransactions_Transactions(self.props.banque.transactions)))));
    }
}
